  ...
  <div class="container">
    <div class="row gy-4">
      ...
      <div class="col-lg-2 col-6 footer-links">
        <h4>Our Services</h4>
        <ul>
          <li><i class="bi bi-chevron-right"></i> <a href="design">Web Design</a></li>
          <li><i class="bi bi-chevron-right"></i> <a href="development">Web Development</a></li>
          <li><i class="bi bi-chevron-right"></i> <a href="management">Product Management</a></li>
          <li><i class="bi bi-chevron-right"></i> <a href="marketing">Marketing</a></li>
          <li><i class="bi bi-chevron-right"></i> <a href="graphic">Graphic Design</a></li>
        </ul>
      </div>
